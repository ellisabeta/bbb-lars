        ...
        <div className="container mx-auto mt-10 grid md:grid-cols-2 gap-8">
            <div>
                ...
                <ul className="mt-2 space-y-2">
                    <li className="text-red-500 cursor-pointer">Schulbetrieb Übersicht</li>
                    <li className="text-red-500 cursor-pointer">Anmeldung</li>
                    <li className="text-red-500 cursor-pointer">Informationen zum Lehrbeginn</li>
            ...
            <div>
                ...
                <ul className="mt-2 space-y-2">
                    <li className="text-red-500 cursor-pointer">Beratung für BBB-Lernende</li>
